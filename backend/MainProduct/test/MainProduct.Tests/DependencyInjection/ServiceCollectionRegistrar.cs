...
namespace MainProduct.Tests.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            var mainProductBuilder = new DbContextOptionsBuilder<MainProductDbContext>();
            mainProductBuilder.UseInMemoryDatabase(Guid.NewGuid().ToString()).UseInternalServiceProvider(serviceProvider);
            ...
            iocManager.IocContainer.Register(
                Component
                    ...
                    .LifestyleSingleton(),
                Component
                    .For<DbContextOptions<MainProductDbContext>>()
                    .Instance(mainProductBuilder.Options)
                    .LifestyleSingleton()
            );
        }
    }
