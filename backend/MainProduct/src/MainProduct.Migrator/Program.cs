...
namespace MainProduct.Migrator
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            using (var bootstrapper = AbpBootstrapper.Create<MainProductMigratorModule>())
            {
                ...
                using (var migrateExecuter = bootstrapper.IocManager.ResolveAsDisposable<MainProductMigrateExecuter>())
                {
